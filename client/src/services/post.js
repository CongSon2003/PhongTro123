...
export const apiUpdatePostsAdmin = (payload) => new Promise(async(resolve,reject)=>{
    try {
        // put va post : client data => server  body
        // delete va get : client param => server query 
        const response = await axiosConfig({
            method: 'put',
...
export const apiDeletePostsAdmin = (postID) => new Promise(async(resolve,reject)=>{
    try {
        // put va post : client data => server  body
        // delete va get : client param => server query 
        const response = await axiosConfig({
