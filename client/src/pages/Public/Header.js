...
import { LOGIN_PATH, REGISTER_PATH, HOME_PATH } from "../../constants/path";
  ...
  return (
    <div ref={scrollListHead} className="container w-3/4 flex justify-between ">
      ...
      <div className="user-welcome gap-16 flex text-sm align-center float-right items-center font-normal">
        {(isLoggedIn) && <User name={user?.name} phone={user?.phone} id={user?.id}/>}
        <div className="flex justify-around gap-3">
          <a className="btn hover:underline text-[#333] relative">
