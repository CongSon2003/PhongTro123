export const text = {
    titleOne : 'Tại sao lại chọn PhongTro123.com?',
    decription1 : 'Chúng tôi biết bạn có rất nhiều lựa chọn, nhưng Phongtro123.com tự hào là trang web đứng top google về các từ khóa: ',
    decription2 : '...Vì vậy tin của bạn đăng trên website sẽ tiếp cận được với nhiều khách hàng hơn, do đó giao dịch nhanh hơn, tiết kiệm chi phí hơn',
    statistics : [
        {
            name : 'Thành viên',
            value : '116.998+' 
    ...
    titleTwo : 'Chi phí thấp, hiệu quả tối đa',
    star : '5',
